...
public class UpgradeService : IUpgradeService
{
    ...
    public async Task<bool> IsNewVersionAvailable()
    {
        ...
        try
        {
            ...
            var response = await client.GetAsync("https://github.com/immense/Pronetsys/releases/latest");
            ...
            var filePath = Directory.GetFiles(Directory.GetCurrentDirectory(), "Pronetsys_Server.dll", SearchOption.AllDirectories).First();
